...
def call_ollama(message:str, system:str):
    from clientOllama import OllamaClient
    client = OllamaClient()
    return client.chat(message, system)

def call_llm(message:str, system:str):
    return call_ollama(message, system)
